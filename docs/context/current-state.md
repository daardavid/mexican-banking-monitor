...
- Stack: Python 3.12, `uv`, PostgreSQL/Supabase, Supabase CLI migrations, GitHub Actions, YAML,
  Ruff, Mypy, Pytest, Streamlit, and Plotly.
...
- `PR1 chore/freeze-operational-contract` — IN PROGRESS.
- `PR2 chore/pin-python-uv-toolchain` — NEXT.
...
- A read-only remote Supabase inventory is still pending. It must verify migration history,
  ...
  It does not block this documentation-only PR1.
